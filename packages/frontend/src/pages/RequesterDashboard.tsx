...
import type { ApiResponse, DataUpload, ConsentRequest, User } from '@/types'
  ...
  if (!isAuthenticated && !activeAccount) {
    return (
      <div className="flex items-center justify-center py-20">
        <p className="text-muted-foreground">Please connect your wallet or use demo login to access the Requester Dashboard.</p>
      </div>
    )
  }
